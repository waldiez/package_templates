...
import axiosInstance, { ApiError, ApiErrorDetail, getErrorMessage } from "@my/package/api/axiosInstance";
...
describe("axiosInstance", () => {
    ...
    describe("getErrorMessage", () => {
        ...
        it("should use error.response.data string as the message", () => {
            const error: AxiosError = {
                response: { data: "Error message" } as any,
            } as AxiosError;
    ...
    describe("interceptors", () => {
        ...
        it("should use fallback status code if not provided in ECONNABORTED", async () => {
            const axiosError = new AxiosError("Server error", "ECONNABORTED");
            axiosError.response = { data: { message: "Server failure" } } as any;
